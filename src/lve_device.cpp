...
// local callback functions
    ...
    std::unique_ptr<LveDevice> instance_ = nullptr;

    void LveDevice::init(LveWindow &lveWindow) {
        if (!instance_) {
            instance_ = std::make_unique<LveDevice>(lveWindow);
            std::cout << "LveDevice Initialized" << std::endl;
        }
    }

    LveDevice &LveDevice::get() {
        if (!instance_) throw new std::runtime_error("LveDevice Not Initialized");
        return *instance_;
    }
...
// class member functions
    ...
    // LveDevice::~LveDevice() {
    //     std::cout << "[LveDevice] Destroying command pool..." << std::endl;
    //     vkDestroyCommandPool(device_, commandPool, nullptr);
    //
    //     std::cout << "[LveDevice] Destroying device..." << std::endl;
    //     vkDestroyDevice(device_, nullptr);
    //
    //     if (enableValidationLayers) {
    //         std::cout << "[LveDevice] Destroying debug messenger..." << std::endl;
    //         DestroyDebugUtilsMessengerEXT(instance, debugMessenger, nullptr);
    //     }
    //
    //     std::cout << "[LveDevice] Destroying surface..." << std::endl;
    //     vkDestroySurfaceKHR(instance, surface_, nullptr);
    //
    //     std::cout << "[LveDevice] Destroying Vulkan instance..." << std::endl;
    ...
    void LveDevice::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
    ...
    void LveDevice::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
